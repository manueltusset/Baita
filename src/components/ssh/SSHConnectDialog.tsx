...
export default function SSHConnectDialog({ onClose, onConnect, inline }: SSHConnectDialogProps) {
  ...
  const labelStyle = {
    fontSize: inline ? "10px" : "var(--font-size-sm)",
  ...
  const formContent = (
    <>
      <div style={{
        ...
        alignItems: "center",
        marginBottom: inline ? "10px" : "20px",
      }}>
        <div style={{
          fontSize: inline ? "var(--font-size-sm)" : "var(--font-size-lg)",
          fontWeight: 700,
          fontFamily: "var(--font-display)",
        }}>
          New Connection
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: inline ? "8px" : "12px" }}>
        <div>
